        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex">
                ...
                @if(!$note->trashed())
                    ...
                    <p class="opacity-70 px-6">
                        <strong>Updated: </strong> {{ $note->updated_at->diffForHumans() }}
                    </p>

                    <a href="{{ route('notes.edit', $note) }}" class="btn-link ml-auto hover:bg-slate-700 duration-500 ease-in-out">Edit Note</a>
                ...
                @else
                    ...
                    <form action="{{ route('trashed.destroy', $note) }}" method="POST">
                        @method('delete')
                        @csrf
                        <button type="submit" class="btn btn-danger ml-4" onclick="return confirm('Are you sure you wish to delete this note forever? This action cannot be undone.');">Delete</button>
                    </form>
                @endif
            </div>
